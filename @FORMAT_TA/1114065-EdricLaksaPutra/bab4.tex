...
Pada bagian ini akan dilakukan perbandingan terhadap kedua jenis model arsitektur. Pengujian akan dilakukan dengan membandingkan hasil \textit{test plan} yang telah dibuat. Perbandingan dilakukan dengan memberikan analisa dan bukti dari bagaimana sistem bekerja pada kedua jenis arsitektur untuk setiap faktor uji yang terdiri dari : Performa, tingkat availabilitas, tingkat stabilitas, skalabilitas, dan reliabilitas dari sistem.//
